...
print ('''\033[1;34m
  _   _      _   ____                      _               
 | \ | |    | | |  _ \                    | |              
 |  \| | ___| |_| |_) |_ __ ___  __ _  ___| |__   ___ _ __ 
 | . ` |/ _ \ __|  _ <| '__/ _ \/ _` |/ __| '_ \ / _ \ '__|
 | |\  |  __/ |_| |_) | | |  __/ (_| | (__| | | |  __/ |   
 |_| \_|\___|\__|____/|_|  \___|\__,_|\___|_| |_|\___|_|   
...
print ('''\n  I am not responsible for your shit and if you get some error while
 running NetBreacher, there are good chances that target isn't responding.\n''')
print ('\033[1;31m--------------------------------------------------------------------------\033[1;m\n')

try:
	target = target.replace('https://', '') #Removes https://
except:
	print ('\033[1;31m[-]\033[1;m -u argument is not supplied. Enter python netbreacher -h for help')
	quit()
...
def scan(links):
	for link in links: #fetches one link from the links list
		...
		if http == 200: #if its 200 the url points to valid resource i.e. admin panel
			print ('  \033[1;32m[+]\033[0m Congrats nigger, Admin panel found: %s'% link)
